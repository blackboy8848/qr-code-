      ...
      <div className="flex flex-1 flex-col px-4 py-4 md:px-6 md:py-6">
        ...
        <section className="flex flex-1 flex-col gap-4 rounded-2xl bg-slate-900/70 p-5 ring-1 ring-slate-800">
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
            {/* Chat column */}
            <div className="lg:col-span-2 rounded-xl bg-slate-950/40 p-4 ring-1 ring-slate-800/60">
              <div className="flex items-start justify-between gap-4">
                ...
                {selectedSessionId && (
                  <div className="shrink-0 rounded-full bg-slate-800 px-3 py-1 text-[10px] font-medium text-slate-100">
                    People registered:{" "}
              ...
              <div className="mt-4 min-h-[380px] max-h-[520px] overflow-y-auto">
                {selectedSessionId ? (
            ...
            {/* QR column */}
            <div className="rounded-xl bg-slate-950/40 p-4 ring-1 ring-slate-800/60">
              {currentQrUrl && selectedSession ? (
                <div className="rounded-2xl bg-slate-950/80 p-3 ring-1 ring-slate-800/80">
                  ...
                  <div className="mt-3 flex items-center justify-center rounded-xl bg-white p-3">
                    <QRCode id="session-qr-svg" value={currentQrUrl} size={160} />
                  </div>
                  ...
                  <p className="mt-3 line-clamp-2 break-all rounded bg-slate-900 px-2 py-1 text-[9px] font-mono text-slate-300">
                    {currentQrUrl}
                  </p>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button
                        ...
                        onClick={() => {
                          ...
                          navigator.clipboard.writeText(currentQrUrl).catch(() => {});
                        }}
                ...
                <div className="flex min-h-[520px] items-center justify-center text-xs text-slate-500">
                  Select a session to show QR code.
                </div>
              )}
            </div>
          </div>

          {/* Registered people below */}
          <div className="rounded-xl bg-slate-950/40 p-4 ring-1 ring-slate-800/60">
